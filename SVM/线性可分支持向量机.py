...
if __name__ == '__main__':
    dataMat, labelMat = loadDataSet('D:\\机器学习实战\\机器学习实战源代码\\Machine-Learning-in-Action-Python3-master\\Machine-Learning-in-Action-Python3-master\\SVM_Project1\\testSet.txt')
