...
def testRbf(k1 = 1.3):
    # 加载训练集
    dataArr, labelArr = loadDataSet('D:\\机器学习实战\\机器学习实战源代码\\Machine-Learning-in-Action-Python3-master\\Machine-Learning-in-Action-Python3-master\\SVM_Project3\\testSetRBF.txt')
    # 根据训练集计算b, alphas
    ...
    # 加载测试集
    dataArr, labelArr = loadDataSet('D:\\机器学习实战\\机器学习实战源代码\\Machine-Learning-in-Action-Python3-master\\Machine-Learning-in-Action-Python3-master\\SVM_Project3\\testSetRBF2.txt')
    errorCount = 0
    datMat = np.mat(dataArr)
    labelMat = np.mat(labelArr).transpose()
    m, n = np.shape(datMat)
